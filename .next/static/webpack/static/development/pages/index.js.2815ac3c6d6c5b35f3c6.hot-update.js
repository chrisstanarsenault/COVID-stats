...
function convertDate(apiDate) {
  ...
  var date = d.substring(0, 4); // let month = d.getMonth();
  // let year = d.getFullYear();
  // let dateStr = `${pickMonth(month)} ${date}, ${year}`;

  console.log("1: ", apiDate);
  console.log("2: ", d); // console.log("3: ", d.toLocaleDateString())
...
//# sourceMappingURL=index.js.2815ac3c6d6c5b35f3c6.hot-update.js.map