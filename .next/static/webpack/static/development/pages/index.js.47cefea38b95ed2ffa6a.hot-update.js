...
function convertDate(apiDate) {
  ...
  var dateStr = "".concat(pickMonth(parseInt(month - 1)), " ").concat(date, ", ").concat(year);
  console.log("1: ", apiDate);
  console.log("2: ", d);
  console.log("date: ", date);
  console.log("month: ", month);
  console.log(typeof month); // console.log("3: ", d.toLocaleDateString())
...
//# sourceMappingURL=index.js.47cefea38b95ed2ffa6a.hot-update.js.map